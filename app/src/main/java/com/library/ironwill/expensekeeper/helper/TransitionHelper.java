package com.library.ironwill.expensekeeper.helper;
...
public class TransitionHelper {
    ...
    public static ActivityOptionsCompat makeOptionsCompat(Activity fromActivity, Pair<View, String>... sharedElements) {
        ...
        for (ListIterator<Pair<View, String>> iterator = list.listIterator(); iterator.hasNext(); ) {
            Pair pair = iterator.next();
            if (pair.first == null) iterator.remove();
        }
    ...
    public static class BaseActivity extends FragmentActivity implements TransitionHelper.Source, TransitionHelper.Listener {
