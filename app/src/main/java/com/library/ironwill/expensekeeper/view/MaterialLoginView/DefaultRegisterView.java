...
public class DefaultRegisterView extends FrameLayout implements RegisterView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.register_card, this, true);
...
//        TextView registerTitle = (TextView) findViewById(R.id.register_title);
        ...
        try {
            String string;
//            = a.getString(R.styleable.DefaultRegisterView_registerTitle)
            /*if (string != null) {
            ...
            int color = a.getColor(R.styleable.DefaultRegisterView_registerTextColor, ContextCompat.getColor(getContext(), R.color.black));
