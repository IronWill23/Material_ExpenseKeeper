...
import com.library.ironwill.expensekeeper.util.CommonUtils;
...
public class PullToLoadView extends FrameLayout {
    ...
    public PullToLoadView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSwipeRefreshLayout.setColorSchemeColors(Color.WHITE, Color.WHITE);//设置水滴中旋转动画的颜色，参数1:水滴落下过程中的颜色，参数2:水滴已经落下后的颜色
