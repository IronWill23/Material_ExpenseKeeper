package com.library.ironwill.expensekeeper.view.statisticView;
...
import com.library.ironwill.expensekeeper.util.CalculateUtil;
import com.library.ironwill.expensekeeper.util.DensityUtil;
...
public class BarChart extends View {
    ...
    private List<BarModel> mData;//数据集合
    /**
     * 右边的最大和最小值
     */
