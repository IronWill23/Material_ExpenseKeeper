package com.library.ironwill.expensekeeper.view.FloatingButtonFamiliy;
...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public Animation AlphaBigAnim(int duration) {
    AlphaAnimation alphaAnim = new AlphaAnimation(0.0f,1.0f);
    alphaAnim.setDuration(duration);
    alphaAnim.setFillAfter(true);
    return alphaAnim;
  }
  public Animation AlphaSmallAnim(int duration) {
